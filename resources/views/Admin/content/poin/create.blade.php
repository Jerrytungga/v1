          ...
          <div class="card-body">
            <form action="{{ route('poin.store') }}" method="post">
              ...
              <div class="modal-body">
                ...
                <!-- Financial Field -->
                <div class="form-group row">
                  <label for="keuangan" class="col-sm-2 col-form-label">Financial</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="keuangan" name="keuangan" required placeholder="Enter Poin Financial">
                    @error('keuangan')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </div>
