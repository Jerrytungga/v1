...
@section('content')
  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="text-uppercase">form edit target point weekly</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <form action="{{ route('poin.update', $poinjurnal->id) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="number" class="form-control" id="agenda" name="keuangan" value="{{ old('keuangan', $poinjurnal->finance) }}" required placeholder="Enter Poin Finance">
                            </div>
                        </div>
