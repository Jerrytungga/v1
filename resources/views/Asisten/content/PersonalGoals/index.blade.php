              ...
              <div class="card-header">
                ...
                <form action="{{ route('personalgoals-week', $ambil_trainee->nip) }}" method="POST">
                  ...
                  <div class="form-inline">
                    ...
                    <a href="{{ route('personalgoals-Asisten', $ambil_trainee->nip) }}" class="btn btn-danger ml-2">Reset</a>
                  </div>
                </form>
              </div>
              <!-- /.card-header -->
                            ...
                            <div class="modal fade" id="ipoin-{{ $data->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form action="{{ route('personalgoals-poin', ['id' => $data->id]) }}" method="POST">
                                      @csrf
                                      @method('PATCH')
                                      <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                                        <div class="form-group">
                                          <label for="Description">Description :</label>
                                          <textarea name="" class="form-control mb-1" disabled id="">{{ $data->personalgoals }}</textarea>
