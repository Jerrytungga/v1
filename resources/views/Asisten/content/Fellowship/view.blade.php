          ...
          <div class="col-12">
            <div class="card">
              ...
              <a href="{{ route('pengembalaan-trainee') }}" class="btn text-light mr-1 mb-1 bg-dark">Back To Shepherded </a>
                ...
                <form action="{{ route('view_fellowship_filter', ['nip' => $ambil_trainee->nip, 'semester' => $semester]) }}" method="POST">
                  @csrf
                  <div class="form-inline">
                    ...
                    <a href="{{ route('view-fellowship', ['nip' => $ambil_trainee->nip, 'semester' => $semester]) }}" class="btn btn-danger ml-2">Reset</a>
