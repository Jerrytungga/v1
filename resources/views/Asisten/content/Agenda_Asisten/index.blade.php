          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <form action="{{ route('Agenda-week', $ambil_trainee->nip) }}" method="POST">
                  @csrf
                  <div class="form-inline">
                    ...
                    <a href="{{ route('Agenda-Asisten', $ambil_trainee->nip) }}" class="btn btn-danger ml-2">Reset</a>
                  </div>
                </form>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    @if ($ambil_Agenda->isNotEmpty())
                  @foreach($ambil_Agenda as $data)
                  <tr>
                      <td class="col-1">{{ $data->created_at }}</td>
                      <td class="col-6">{{ $data->agenda }}
                                    ...
                                    <form action="{{ route('Agenda-poin', ['id' => $data->id]) }}" method="POST">
                                      ...
                                      <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                                        <div class="form-group">
                                          ...
                                          <textarea name="agenda" disabled class="form-control">{{ $data->agenda }}</textarea>
