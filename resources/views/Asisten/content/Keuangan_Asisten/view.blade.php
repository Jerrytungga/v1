          ...
          <div class="col-12">
            <div class="card">
              ...
              <a href="{{ route('pengembalaan-trainee') }}" class="btn text-light mb-1 bg-dark">Back To Shepherded
                ...
                <form action="{{ route('view_finance_filter', ['nip' => $ambil_trainee->nip, 'semester' => $semester]) }}" method="POST">
                  @csrf
                  <div class="form-inline">
                    ...
                    <a href="{{ route('view-finance', ['nip' => $ambil_trainee->nip, 'semester' => $semester]) }}" class="btn btn-danger ml-2">Reset</a>
                  </div>
                </form>
              </div>
              <!-- /.card-header -->
