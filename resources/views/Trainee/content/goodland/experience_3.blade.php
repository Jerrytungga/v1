  ...
  <div class="container-fluid">
    <div class="row justify-content-left">
      <div class="card m-3" style="width: 100%; max-width: 800px; border-radius: 15px;"> <!-- Memperlebar card -->
        <div class="card-body">
          <form action="{{ route('goodland.saveexperience_3', $data->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <div class="form-row">
                <div class="col-md-4">
                  <textarea name="experience_3" class="form-control" placeholder="Experience 3" style="height: 150px;">{{ old('experience_3', $data->experience_3) }}</textarea> <!-- Mengatur tinggi -->
                </div>
              </div>
            </div>
