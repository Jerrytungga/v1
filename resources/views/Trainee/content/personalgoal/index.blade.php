...
@section('content')
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#staticBackdrop">View Personal Goals Assignment <span class="badge badge-danger">{{$taskCount}}</span></button>

                <!-- Alert for semester and week -->
                @if (!empty($smt))
    ...
    <!-- Modal for Personal Goals Assignment -->
              ...
              <tbody>
                @foreach($tasks as $index => $ambil_data)
                  <tr>
                    ...
                    <td class="col-8">{{ $ambil_data->Assignment }}</td>
                  </tr>
                @endforeach
              </tbody>
            </table>
