          ...
          <div class="card">
            ...
            <div class="form-inline">
              ...
              <div class="card shadow" style="background-color: #CBDCEB;">
               ...
               <div class="card-body">
                  <input type="text" disabled value="{{ $data->asisten_trainer }}" >
                  <input type="text" disabled class="col-2" value="{{ $data->topic }}" >
                 ...
                 <a href="{{route('fellowship.edit', $data->id)}}" class="btn btn-sm mb-1 btn-warning">Edit</a>
                  @endif
                  <br>
                  <textarea disabled id="" cols="30" rows="5" class="form-control mt-1">{{ $data->notes_trainee }}</textarea>
                  <textarea disabled id="" cols="30" rows="5" class="form-control mt-1">{{ $data->action }}</textarea>
                  @if (!empty($data->catatan))
